...
public class GlobalQuality : GlobalItem
{
    ...
    public bool UpdateInventoryQuality = false;
    ...
    public void RollQuality(Item item)
    {
        ...
        if (ItemRoll <= 0.005f)
        {
            ...
            {
                quality = Main.rand.Next(95, 99 + 1); // In inferno mode, chance of getting 95-99% quality is 0.5% 
            }
        }
        if (ItemRoll <= 0.0001f)
        {
            ...
            if (GlobalNPCBuff.NightmareMode)
            {
                quality = Main.rand.Next(95, 99 + 1);
            }
            if (GlobalNPCBuff.InfernoMode)
            {
                quality = 100; // In inferno mode, chance of getting 100% quality is 0.01%
            }
        }
